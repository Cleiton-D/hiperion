...
public interface IDisplayIfProcessor {
    ...
    void displayPictIf(Boolean condition);
    
    void displayShapeIf(Boolean condition);
    
    void displayTextBoxIf(Boolean condition);
    
    void displayTextBoxContentIf(Boolean condition);
